...
export default function DisclaimerSection() {
  return (
    <section className="py-16" id="disclaimer">
      <div className="py-6 my-6 bg-white/40 border-t-4 border-black/10">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-4">
            ...
            veya tedavi önerisi amacı taşımaz. Sadece sitedeki bilgilerden yola
            çıkarak tedavi veya teşhis yapılmamalıdır. Hiçbir yazı, online
            görüşme veya konuşma, birebir muayene ve detaylı hikaye ile birlikte
            kararlaştırılan tedavi ve teşhisten güçlü değildir.
          </p>
